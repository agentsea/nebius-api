...
pub mod operation_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.common.v1alpha1.OperationService", "Get"),
                );
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.common.v1alpha1.OperationService", "List"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod operation_service_server {
    ...
    #[derive(Debug)]
    pub struct OperationServiceServer<T: OperationService> {
        inner: Arc<T>,
    ...
    impl<T: OperationService> OperationServiceServer<T> {
        pub fn new(inner: T) -> Self {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/nebius.common.v1alpha1.OperationService/Get" => {
                    ...
                    struct GetSvc<T: OperationService>(pub Arc<T>);
                    impl<
                        T: OperationService,
                    ...
                    for GetSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as OperationService>::get(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/nebius.common.v1alpha1.OperationService/List" => {
                    #[allow(non_camel_case_types)]
                    struct ListSvc<T: OperationService>(pub Arc<T>);
                    impl<
                        T: OperationService,
                    ...
                    for ListSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OperationService>::list(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: OperationService> Clone for OperationServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: OperationService> tonic::server::NamedService for OperationServiceServer<T> {
        const NAME: &'static str = "nebius.common.v1alpha1.OperationService";
    }
}
