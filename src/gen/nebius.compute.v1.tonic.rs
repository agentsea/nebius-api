...
pub mod disk_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.DiskService", "Get"));
        ...
        pub async fn get_by_name(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.DiskService", "GetByName"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn list(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.DiskService", "List"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn create(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.DiskService", "Create"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn update(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.DiskService", "Update"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn delete(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.DiskService", "Delete"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn list_operations_by_parent(
            &mut self,
            request: impl tonic::IntoRequest<super::ListOperationsByParentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::common::v1::ListOperationsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod disk_service_server {
    ...
    pub trait DiskService: Send + Sync + 'static {
        ...
        async fn list_operations_by_parent(
            &self,
            request: tonic::Request<super::ListOperationsByParentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::common::v1::ListOperationsResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/nebius.compute.v1.DiskService/ListOperationsByParent" => {
                    ...
                    impl<
                        T: DiskService,
                    > tonic::server::UnaryService<super::ListOperationsByParentRequest>
                    for ListOperationsByParentSvc<T> {
                        type Response = super::super::super::common::v1::ListOperationsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
    ...
    impl<T: DiskService> tonic::server::NamedService for DiskServiceServer<T> {
        const NAME: &'static str = "nebius.compute.v1.DiskService";
    }
}
/// Generated client implementations.
pub mod filesystem_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.FilesystemService", "Get"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_by_name(
            &mut self,
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.compute.v1.FilesystemService", "GetByName"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn list(
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.FilesystemService", "List"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn create(
            &mut self,
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.compute.v1.FilesystemService", "Create"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn update(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.compute.v1.FilesystemService", "Update"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn delete(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.compute.v1.FilesystemService", "Delete"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn list_operations_by_parent(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "nebius.compute.v1.FilesystemService",
                        "ListOperationsByParent",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod filesystem_service_server {
    ...
    for FilesystemServiceServer<T> {
        const NAME: &'static str = "nebius.compute.v1.FilesystemService";
    }
}
/// Generated client implementations.
pub mod gpu_cluster_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.GpuClusterService", "Get"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_by_name(
            &mut self,
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.compute.v1.GpuClusterService", "GetByName"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn list(
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.GpuClusterService", "List"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn create(
            &mut self,
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.compute.v1.GpuClusterService", "Create"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn update(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.compute.v1.GpuClusterService", "Update"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn delete(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.compute.v1.GpuClusterService", "Delete"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn list_operations_by_parent(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "nebius.compute.v1.GpuClusterService",
                        "ListOperationsByParent",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod gpu_cluster_service_server {
    ...
    for GpuClusterServiceServer<T> {
        const NAME: &'static str = "nebius.compute.v1.GpuClusterService";
    }
}
/// Generated client implementations.
pub mod image_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.ImageService", "Get"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_by_name(
            &mut self,
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.ImageService", "GetByName"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_latest_by_family(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "nebius.compute.v1.ImageService",
                        "GetLatestByFamily",
                    ),
                );
            self.inner.unary(req, path, codec).await
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.ImageService", "List"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn list_operations_by_parent(
            &mut self,
...
pub mod image_service_server {
    ...
    impl<T: ImageService> tonic::server::NamedService for ImageServiceServer<T> {
        const NAME: &'static str = "nebius.compute.v1.ImageService";
    }
}
/// Generated client implementations.
pub mod instance_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.InstanceService", "Get"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_by_name(
            &mut self,
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.compute.v1.InstanceService", "GetByName"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn list(
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.InstanceService", "List"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn create(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.InstanceService", "Create"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn update(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.InstanceService", "Update"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn delete(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.InstanceService", "Delete"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn start(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.InstanceService", "Start"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn stop(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.InstanceService", "Stop"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn list_operations_by_parent(
            &mut self,
...
pub mod instance_service_server {
    ...
    impl<T: InstanceService> tonic::server::NamedService for InstanceServiceServer<T> {
        const NAME: &'static str = "nebius.compute.v1.InstanceService";
    }
}
/// Generated client implementations.
pub mod node_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn set_unhealthy(
            &mut self,
            request: impl tonic::IntoRequest<super::NodeSetUnhealthyRequest>,
        ) -> std::result::Result<
            tonic::Response<super::NodeSetUnhealthyResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.compute.v1.NodeService", "SetUnhealthy"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod node_service_server {
    ...
    pub trait NodeService: Send + Sync + 'static {
        async fn set_unhealthy(
            &self,
            request: tonic::Request<super::NodeSetUnhealthyRequest>,
        ) -> std::result::Result<
            tonic::Response<super::NodeSetUnhealthyResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/nebius.compute.v1.NodeService/SetUnhealthy" => {
                    #[allow(non_camel_case_types)]
                    struct SetUnhealthySvc<T: NodeService>(pub Arc<T>);
                    impl<
                        T: NodeService,
                    > tonic::server::UnaryService<super::NodeSetUnhealthyRequest>
                    for SetUnhealthySvc<T> {
                        type Response = super::NodeSetUnhealthyResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NodeService>::set_unhealthy(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SetUnhealthySvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T: NodeService> tonic::server::NamedService for NodeServiceServer<T> {
        const NAME: &'static str = "nebius.compute.v1.NodeService";
    }
}
/// Generated client implementations.
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_by_name(
            ...
            request: impl tonic::IntoRequest<
                super::super::super::common::v1::GetByNameRequest,
            >,
        ) -> std::result::Result<tonic::Response<super::Platform>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.compute.v1.PlatformService", "GetByName"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn list(
            &mut self,
            request: impl tonic::IntoRequest<super::ListPlatformsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListPlatformsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.compute.v1.PlatformService", "List"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod platform_service_server {
    ...
    pub trait PlatformService: Send + Sync + 'static {
        ...
        async fn list(
            &self,
            request: tonic::Request<super::ListPlatformsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListPlatformsResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/nebius.compute.v1.PlatformService/GetByName" => {
                    #[allow(non_camel_case_types)]
                    struct GetByNameSvc<T: PlatformService>(pub Arc<T>);
                    impl<
                        T: PlatformService,
                    > tonic::server::UnaryService<
                        super::super::super::common::v1::GetByNameRequest,
                    > for GetByNameSvc<T> {
                        type Response = super::Platform;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PlatformService>::get_by_name(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/nebius.compute.v1.PlatformService/List" => {
                    #[allow(non_camel_case_types)]
                    struct ListSvc<T: PlatformService>(pub Arc<T>);
                    impl<
                        T: PlatformService,
                    > tonic::server::UnaryService<super::ListPlatformsRequest>
                    for ListSvc<T> {
                        type Response = super::ListPlatformsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PlatformService>::list(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: PlatformService> tonic::server::NamedService for PlatformServiceServer<T> {
        const NAME: &'static str = "nebius.compute.v1.PlatformService";
    }
}
