...
pub mod cluster_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.msp.spark.v1alpha1.ClusterService", "Get"),
                );
        ...
        pub async fn get_by_name(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "nebius.msp.spark.v1alpha1.ClusterService",
                        "GetByName",
                    ),
                );
            self.inner.unary(req, path, codec).await
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.msp.spark.v1alpha1.ClusterService", "List"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn create(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.msp.spark.v1alpha1.ClusterService", "Create"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn update(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.msp.spark.v1alpha1.ClusterService", "Update"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn delete(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.msp.spark.v1alpha1.ClusterService", "Delete"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod cluster_service_server {
    ...
    impl<T: ClusterService> tonic::server::NamedService for ClusterServiceServer<T> {
        const NAME: &'static str = "nebius.msp.spark.v1alpha1.ClusterService";
    }
}
/// Generated client implementations.
pub mod job_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.msp.spark.v1alpha1.JobService", "Get"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn list(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.msp.spark.v1alpha1.JobService", "List"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn create(
            &mut self,
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.msp.spark.v1alpha1.JobService", "Create"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn cancel(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.msp.spark.v1alpha1.JobService", "Cancel"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod job_service_server {
    ...
    impl<T: JobService> tonic::server::NamedService for JobServiceServer<T> {
        const NAME: &'static str = "nebius.msp.spark.v1alpha1.JobService";
    }
}
/// Generated client implementations.
pub mod session_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.msp.spark.v1alpha1.SessionService", "Get"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_by_name(
            &mut self,
            request: impl tonic::IntoRequest<super::GetSessionByNameRequest>,
        ) -> std::result::Result<tonic::Response<super::Session>, tonic::Status> {
            self.inner
                .ready()
                .await
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "nebius.msp.spark.v1alpha1.SessionService",
                        "GetByName",
                    ),
                );
            self.inner.unary(req, path, codec).await
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.msp.spark.v1alpha1.SessionService", "List"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn create(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.msp.spark.v1alpha1.SessionService", "Create"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn delete(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("nebius.msp.spark.v1alpha1.SessionService", "Delete"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod session_service_server {
    ...
    pub trait SessionService: Send + Sync + 'static {
        ...
        async fn get_by_name(
            &self,
            request: tonic::Request<super::GetSessionByNameRequest>,
        ) -> std::result::Result<tonic::Response<super::Session>, tonic::Status>;
        async fn list(
            &self,
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/nebius.msp.spark.v1alpha1.SessionService/GetByName" => {
                    #[allow(non_camel_case_types)]
                    struct GetByNameSvc<T: SessionService>(pub Arc<T>);
                    impl<
                        T: SessionService,
                    > tonic::server::UnaryService<super::GetSessionByNameRequest>
                    for GetByNameSvc<T> {
                        type Response = super::Session;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SessionService>::get_by_name(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/nebius.msp.spark.v1alpha1.SessionService/Create" => {
                    #[allow(non_camel_case_types)]
                    struct CreateSvc<T: SessionService>(pub Arc<T>);
                    impl<
                        T: SessionService,
                    ...
                    for CreateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SessionService>::create(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/nebius.msp.spark.v1alpha1.SessionService/Delete" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteSvc<T: SessionService>(pub Arc<T>);
                    impl<
                        T: SessionService,
                    ...
                    for DeleteSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SessionService>::delete(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: SessionService> tonic::server::NamedService for SessionServiceServer<T> {
        const NAME: &'static str = "nebius.msp.spark.v1alpha1.SessionService";
    }
}
