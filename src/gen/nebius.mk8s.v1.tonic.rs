...
pub mod cluster_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.mk8s.v1.ClusterService", "Get"));
        ...
        pub async fn get_by_name(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.mk8s.v1.ClusterService", "GetByName"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn list(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.mk8s.v1.ClusterService", "List"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn create(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.mk8s.v1.ClusterService", "Create"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn update(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.mk8s.v1.ClusterService", "Update"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn delete(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.mk8s.v1.ClusterService", "Delete"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod cluster_service_server {
    ...
    impl<T: ClusterService> tonic::server::NamedService for ClusterServiceServer<T> {
        const NAME: &'static str = "nebius.mk8s.v1.ClusterService";
    }
}
/// Generated client implementations.
pub mod node_group_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.mk8s.v1.NodeGroupService", "Get"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_by_name(
            &mut self,
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.mk8s.v1.NodeGroupService", "GetByName"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn list(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.mk8s.v1.NodeGroupService", "List"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn create(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.mk8s.v1.NodeGroupService", "Create"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn update(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.mk8s.v1.NodeGroupService", "Update"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn delete(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.mk8s.v1.NodeGroupService", "Delete"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.mk8s.v1.NodeGroupService", "Upgrade"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod node_group_service_server {
    ...
    impl<T: NodeGroupService> tonic::server::NamedService for NodeGroupServiceServer<T> {
        const NAME: &'static str = "nebius.mk8s.v1.NodeGroupService";
    }
}
