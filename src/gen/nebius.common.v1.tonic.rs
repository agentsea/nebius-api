...
pub mod operation_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.common.v1.OperationService", "Get"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("nebius.common.v1.OperationService", "List"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod operation_service_server {
    ...
    impl<T: OperationService> tonic::server::NamedService for OperationServiceServer<T> {
        const NAME: &'static str = "nebius.common.v1.OperationService";
    }
}
